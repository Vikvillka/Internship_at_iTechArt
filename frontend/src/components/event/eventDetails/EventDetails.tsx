...
import { Box, CardMedia, Chip, Container, Paper, Typography, Divider } from '@mui/material';
  ...
  return (
    <Container className={classes.container}>
      <Box className={classes.leftColumn}>
        <Typography className={classes.title} variant='h4'>{event.title}</Typography>
        ...
        <Box className={classes.detailsBox}>
          <Typography className={classes.detailTextBold} variant='h5'>Details</Typography>
      ...
      <Box className={classes.rightColumn}>
        <CardMedia
          ...
          alt={event.title}
        />
        <Typography variant='h5' className={classes.detailTextBold}>What's interesting about us?</Typography>
