...
public class GetUserReplyConverter : ITypeConverter<GetUserReply, GatewayUserResponse>
{
    public GatewayUserResponse Convert(GetUserReply src, GatewayUserResponse dest, ResolutionContext context)
    {
        if (src.ResultCase == GetUserReply.ResultOneofCase.User)
        {
